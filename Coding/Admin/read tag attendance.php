...
<head>
	...
	<body>	
		<div>
			<form class="form-horizontal" action="insertDBkehadiran.php" method="post" >
			<input type="hidden" name="idpelajar" value="<?php echo $data['idpelajar'];?>" >
						...
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								<tr>
									...
									<td align="left"><?php echo $data['norfid'];?></td>
								</tr>
								<tr bgcolor="#f2f2f2">
