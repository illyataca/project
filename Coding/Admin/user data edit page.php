<?php
	...
	$sql = "SELECT * FROM pelajar where norfid = ?";
	$q = $pdo->prepare($sql);
	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #FF0D71;">
				<div class="row">
					<h3 align="center">Edit Students</h3>
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					<div class="control-group">
						...
						<div class="controls">
							<input name="norfid" type="text"  placeholder="" value="<?php echo $data['norfid'];?>" readonly>
						</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label">Fee's</label>
						<div class="controls">
							<input name="fee" type="text"  placeholder="" value="<?php echo $data['fee'];?>" required>
						</div>
					</div>
